...
class DeveloperController extends AbstractController
{
    ...
    public function create(Request $request): Response
    {
        ...
        try {
            ...
            $developer = $this->developerService->createDeveloper($developerDTO);
    ...
    public function transferDeveloper(int $developerId, Request $request): Response
    {
        ...
        try {
            $this->developerService->transferDeveloperToProject($developerId, $newProjectId);
    ...
    public function updatePosition(int $developerId, Request $request): Response
    {
        ...
        try {
            $this->developerService->updateDeveloperPosition($developerId, $newPosition);
    ...
    {
        try {
            $this->developerService->dismissDeveloperFromProject($developerId);
